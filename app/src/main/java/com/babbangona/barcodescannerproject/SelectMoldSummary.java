...
public class SelectMoldSummary extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_select_mold_summary);
        ...
        nextCropSummary.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (GetSelectedSeed.equals("Select One:")){
                    ...
                    Intent openShowCropSummary = new Intent(getApplicationContext(), ShowMoldSummary.class);
