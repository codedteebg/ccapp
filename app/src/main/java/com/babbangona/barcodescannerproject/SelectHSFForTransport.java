    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hsfRecycler.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), hsfRecycler, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                final hsf hsf = hsfTransportAdapter.getItem(position);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SelectHSFForTransport.this);
                builder.setTitle("Pay Transporter");
                builder.setMessage("Please pay transporter " + hsf.getTransporterID() + " N" + AmountPaid);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        AppExecutors.getInstance().diskIO().execute(new Runnable() {
                            ...
                            public void run() {
                                ...
                                mDb.inventoryTDao().updateTransport(hsf.getHSFID());
                                if(iid > 0){
